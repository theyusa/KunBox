...
## [2.7.0](https://github.com/theyusa/KunBox/compare/v2.6.6...v2.7.0) (2026-01-28)


### Features

* add release-please workflow to auto-create release PRs ([43a0516](https://github.com/theyusa/KunBox/commit/43a051623d0e07eb8507fd25c6efb08fa1be3e2c))
* **core:** add kernel-level hot reload for config changes ([c4732a3](https://github.com/theyusa/KunBox/commit/c4732a37c5673c547c01970d2b5b37c2ab90133c))
* improve node link parsing and latency test settings ([3bf90af](https://github.com/theyusa/KunBox/commit/3bf90af0a7b0a420a2e51827e0293446ba38e51e))
* **ipc:** improve VPN state management and add kernel build docs ([ce8d5e9](https://github.com/theyusa/KunBox/commit/ce8d5e972f2602596f2a1c28c89b46a8beccab94))
* **kernel:** add kernel-level HTTP fetch and URLTest extensions ([fa6cd20](https://github.com/theyusa/KunBox/commit/fa6cd20bc48f86b8a64b48da48185e073b621cf0))
* **latency:** persist node latency data and optimize libbox build ([316ed9b](https://github.com/theyusa/KunBox/commit/316ed9b24f1ef98bb0a4e5bdcbcfc70c2623c0f0))
* **network:** add NetworkSwitchManager for WiFi/Cellular handoff ([a88a18f](https://github.com/theyusa/KunBox/commit/a88a18fa0cd040b5b0d55d7c9b4385ca6cdc2610))
* **nodes:** add latency test progress bar with success/timeout stats ([7d333a3](https://github.com/theyusa/KunBox/commit/7d333a332536fb59f999c511ae99263c6f768cdb))
* **nodes:** add profile selection for manual node creation ([4da7bef](https://github.com/theyusa/KunBox/commit/4da7bef9ce9708ab0b4878ea8c7ebc525c6388d3))
* **nodes:** 优化搜索栏设计 ([1e3a2db](https://github.com/theyusa/KunBox/commit/1e3a2dbb49c5682dc4c0e6d6b81ba03cd06d08da))
* **nodes:** 搜索栏跟随滚动显隐 ([dfda72a](https://github.com/theyusa/KunBox/commit/dfda72a54ed1854e7f0af8223982de9f6a345916))
* **parser:** add Clash Meta advanced features support ([d60e3a2](https://github.com/theyusa/KunBox/commit/d60e3a2639b73bcaef2ea9b6b74c4a2bded9be6a))
* **routing:** smart domain recognition + fix domain routing priority ([4014073](https://github.com/theyusa/KunBox/commit/4014073ebc221ff0da0bfc1b793ea275e82d4e5c))
* **ui:** improve navigation animations and add gengar floating effect ([6f8c214](https://github.com/theyusa/KunBox/commit/6f8c214e4ef14d7a725e21e2f63d4d7a911a5268))
* **ui:** optimize app selector dialog layout and sort selected apps first ([35b9ea2](https://github.com/theyusa/KunBox/commit/35b9ea26d335419f688eb069f09b5d684bc1a2d4))
* **ui:** sync node selector dialog state with nodes list ([624b1d0](https://github.com/theyusa/KunBox/commit/624b1d0788950fb141e1211b04d01144177a2b11))
* update workflow logic and dynamic versioning ([e76fbdf](https://github.com/theyusa/KunBox/commit/e76fbdfa5d19963a87ce312da5bdace6031dbc64))
* **update:** implement app version check and notification ([ee5ee2f](https://github.com/theyusa/KunBox/commit/ee5ee2f8d2c56ce27d4abe684aee04cfdc45113b))
* 优化磁贴交互与CI配置，完善文档 ([49447bc](https://github.com/theyusa/KunBox/commit/49447bc146990562c06cb9dea8f70d21196c2ced))
* 应用分流 ([6193046](https://github.com/theyusa/KunBox/commit/6193046e9e36400031d6b8abd77d0e7a6ff653db))


### Bug Fixes

* ：JSON 格式不标准 (Gson 解析异常) ([a9f2c86](https://github.com/theyusa/KunBox/commit/a9f2c8621408523b3df34266b376aa5b4b9c9303))
* ? ([57a84d7](https://github.com/theyusa/KunBox/commit/57a84d73670733961c794000925d7d29ece33cfe))
* 2 ([795f2ec](https://github.com/theyusa/KunBox/commit/795f2ec3a768c516bef42a71069ad92f4b85f628))
* Add English;随便修了一些bug ([f0a12ff](https://github.com/theyusa/KunBox/commit/f0a12ff70727ecaaec5c1f2d354255b0b3623751))
* bug ([cb5f10a](https://github.com/theyusa/KunBox/commit/cb5f10aaa95771d0e47b3289797654b30e64ed87))
* bug修复 ([f6ab50f](https://github.com/theyusa/KunBox/commit/f6ab50f1f5d610507122213d6af08edba1309234))
* **ci:** merge build into release-please workflow ([9845fda](https://github.com/theyusa/KunBox/commit/9845fdaac2d0ef089bad73533be87c5586feedf6))
* **ci:** separate release-please and build workflows ([d879764](https://github.com/theyusa/KunBox/commit/d879764566791477d43d6809d815a71279b5a7ff))
* **config:** node state persistence and profile node memory ([a34bab3](https://github.com/theyusa/KunBox/commit/a34bab312758b6c324c518441c2f4c3cedd0c9c7))
* **core:** 修复 VPN 服务因 bbolt 数据库并发冲突导致自动停止的 bug ([ac301f7](https://github.com/theyusa/KunBox/commit/ac301f7df98f35c1e6596f895f04d2e2a88b65bf))
* **core:** 彻底修复 bbolt panic - 根本原因是多进程并发访问同一数据库 ([42ba8cf](https://github.com/theyusa/KunBox/commit/42ba8cf0018dda3f9e02e8702e8971f4ee75ac86))
* **core:** 确保测试数据库目录存在 - 添加 mkdirs() 调用 ([d57838d](https://github.com/theyusa/KunBox/commit/d57838d98dca559ec49f06eaad68e6db03c82764))
* **data:** persist node latency and improve update check ([a017357](https://github.com/theyusa/KunBox/commit/a017357603793546c4a54462d236f6fd9ea282a8))
* **db:** remove foreign key constraint to fix node latency persistence ([905b07e](https://github.com/theyusa/KunBox/commit/905b07e10782d4d12c68f98db6c799ed3643ff59))
* **filter:** preserve filter keywords when switching filter modes ([e21efa8](https://github.com/theyusa/KunBox/commit/e21efa8dc620ded02557bb28d5a18c501b877086))
* force release pr generation ([9a7398a](https://github.com/theyusa/KunBox/commit/9a7398ad4fbc59fa431aecedb55f91796b9b8d93))
* huawei ([b4ad894](https://github.com/theyusa/KunBox/commit/b4ad8941688d31aaa3b6ad5ec550fa04a2d6b4dc))
* Hysteria2 port range format and code structure issues ([65fbea1](https://github.com/theyusa/KunBox/commit/65fbea158e3d16118f9c476109db0769a3ec4095))
* internet op ([87c8238](https://github.com/theyusa/KunBox/commit/87c8238dcf2d5b27f68bf33293adb291e88ada93))
* **ipc:** resolve UI stuck loading after Doze wake and proxy idle ([14d1713](https://github.com/theyusa/KunBox/commit/14d171353071b3076122efcdefc9d7ce256a88bd))
* **ipc:** 修复从后台恢复后 UI 一直加载中的问题 ([806fa42](https://github.com/theyusa/KunBox/commit/806fa42f911c13f022e75767ce99e2dceb5cb031))
* **ipc:** 修复后台恢复时UI卡住的问题 - 参考NekoBox实现 ([624361a](https://github.com/theyusa/KunBox/commit/624361ac8348093f9fd00eae6767f3b9ee50cfe9))
* **ipc:** 应用返回前台时重置所有连接，修复 TG 等应用一直加载中的问题 ([3549747](https://github.com/theyusa/KunBox/commit/35497474d0fec6031cafa1112d13e118885c3e07))
* **latency-test:** resolve no available network interface error ([ef5b60c](https://github.com/theyusa/KunBox/commit/ef5b60cbcb2aa8bae7e23140a8de4cd0a408effd))
* **latency:** enforce user-configured timeout for single node test ([9103dba](https://github.com/theyusa/KunBox/commit/9103dba01b0f5ac7a1c68c9c358bca52ae804a53))
* **latency:** pass latency value directly in callback to fix race condition ([ac2e134](https://github.com/theyusa/KunBox/commit/ac2e134db6c9c7c5febc2adcff95849cd5a579d2))
* **latency:** remove retry and fallback in batch latency test ([2deac44](https://github.com/theyusa/KunBox/commit/2deac4457673cea8cd766868ce5ececc280b64b0))
* **latency:** resolve SS+ShadowTLS dependency for latency testing ([451e29e](https://github.com/theyusa/KunBox/commit/451e29eded484e531a0861faab0043fbeac0bfea))
* **latency:** restore latency data when switching profiles ([67afd6f](https://github.com/theyusa/KunBox/commit/67afd6f276d17574f5491fab5752a7fe33be3aaf))
* **latency:** support latency testing for nodes from all profiles ([020f82b](https://github.com/theyusa/KunBox/commit/020f82b1b6c755af1e2ae0a578c323f9051ffd7d))
* **libbox:** adapt to new CommandServer API and fix service shutdown ([6b3df81](https://github.com/theyusa/KunBox/commit/6b3df8176adfec224a03b180fb21880d8214237b))
* **memory:** optimize memory usage with LRU caches and static TypeTokens ([f25fa5e](https://github.com/theyusa/KunBox/commit/f25fa5eea01a9343fd4208448dd1bb731e622769))
* **nav:** correct route mapping for Diagnostics and Logs pages ([cd18066](https://github.com/theyusa/KunBox/commit/cd18066b55adcd8aae379e7e1438db7f85629ee1))
* **network:** add idle connection cleanup for TG image loading issue ([b6c54ef](https://github.com/theyusa/KunBox/commit/b6c54efe70dda696c0f3b5efc8d504dec6d9f32c))
* **network:** add proactive recovery for faster foreground resume ([85764bd](https://github.com/theyusa/KunBox/commit/85764bd46b5e2770d1a9703077eecae8c336f5f6))
* **notification:** persist activeLabel to VpnStateStore for cross-process sync ([f7507ae](https://github.com/theyusa/KunBox/commit/f7507ae62ca9119077d26d26f035c1c7afadd837))
* optimize network recovery for faster app reconnection after background ([f6b6c7a](https://github.com/theyusa/KunBox/commit/f6b6c7a431aeeee87c2e416892859e83a0fa1cfa))
* **parser:** add wireguard and ssh link parsing support ([3494923](https://github.com/theyusa/KunBox/commit/3494923947477f59bcffa927734bc11e90050dea))
* **parser:** handle empty string fields in Clash YAML hysteria2 nodes ([a4edefc](https://github.com/theyusa/KunBox/commit/a4edefc3608b4a6bc62e6cfb75be9148d2ca4aef))
* **parser:** handle multiple links in clipboard import ([223c085](https://github.com/theyusa/KunBox/commit/223c0852fd539ee5a7cc6150dd72062735032067))
* **parser:** 修复 vmess 链接无法从剪贴板导入的问题 ([882eeca](https://github.com/theyusa/KunBox/commit/882eeca4b2861c8c15f09b01ba3b3d51acb32db5))
* **power:** add background power saving with configurable delay ([208d59a](https://github.com/theyusa/KunBox/commit/208d59a1f1ae3cdbbba9d3c80d2cccda4164e09b))
* **power:** enable main process self-termination for power saving ([0b39d1f](https://github.com/theyusa/KunBox/commit/0b39d1f70e0faf5e330ee7ef82c90d6742626920))
* remove unused import and fix indentation ([37c31a8](https://github.com/theyusa/KunBox/commit/37c31a89d0f9eb99aab9d77eb4579ce88f469fba))
* **rulesets:** initialize defaults with toggleable downloads ([6d522ff](https://github.com/theyusa/KunBox/commit/6d522ff25c7eeba18f0073762b3d363668d97927))
* **rulesets:** load geosite list via github tree ([79e06b4](https://github.com/theyusa/KunBox/commit/79e06b4f1b0865f10fb7204ec98504d47cfd615e))
* **service:** notification bar node switch not working ([3dfb731](https://github.com/theyusa/KunBox/commit/3dfb731d438376eb176245e0b314f6d071c76b3a))
* **service:** notification not dismissed when app removed from recents ([1dc9834](https://github.com/theyusa/KunBox/commit/1dc983460b537444372366ceeba44f29ca71e4fd))
* **service:** 修复息屏后返回App时Telegram等应用一直加载的问题 ([137e64d](https://github.com/theyusa/KunBox/commit/137e64d65dfaa8b7181dcd2990181f34c3ee8e7c))
* **settings:** 移除断线重连功能和UI ([bc2e5b8](https://github.com/theyusa/KunBox/commit/bc2e5b8bc573e93fcaff264f597641f989028cf1))
* **shortcut:** node selection and VPN toggle not working from app shortcut ([1253563](https://github.com/theyusa/KunBox/commit/12535633853cc1dcee0ea08188405d6d1672f10b))
* **startup:** filter invalid domains in DNS prewarm ([21f404f](https://github.com/theyusa/KunBox/commit/21f404f93c6edfbd2a1eb065a301ce10e63de957))
* **startup:** prevent DoH URL from triggering DNS lookup timeout ([951987a](https://github.com/theyusa/KunBox/commit/951987ac08df8aa04cb6c7fc435186e5e102a9e3))
* **subscription:** 修复取消导入后弹窗重复弹出及应用无法使用自身代理的问题 ([ef12cbb](https://github.com/theyusa/KunBox/commit/ef12cbbf9166d2e87deed1f5d073ade70e38e3a0))
* **subscription:** 兼容订阅剩余/到期信息 ([8af42e1](https://github.com/theyusa/KunBox/commit/8af42e1657ebf1dba2eb3a3d6edd56b13b9e58a5))
* **tun:** refine app list dialog quick select ([21c4c43](https://github.com/theyusa/KunBox/commit/21c4c430db38b1a72cf2dca448a3269dcab4b92d))
* **ui:** add smooth crossfade animation for toggle icon transition ([4cdb257](https://github.com/theyusa/KunBox/commit/4cdb2573bfcbedadee9401c3ef14b89a2d53d87d))
* **ui:** adjust ProfileCard layout weight for better text display ([480ca11](https://github.com/theyusa/KunBox/commit/480ca11005d3e2ca996dab2c3aa4caae133bbded))
* **ui:** clean build warnings and consolidate stability notes ([3eee087](https://github.com/theyusa/KunBox/commit/3eee087a49171f9ab80175f646cb9ad1caaa045c))
* **ui:** improve latency display placeholder ([73fb2a0](https://github.com/theyusa/KunBox/commit/73fb2a09ff46672b91e63a5cfb8e9c536c5149bb))
* **ui:** InputDialog 输入框支持水平滚动 ([a63fcd1](https://github.com/theyusa/KunBox/commit/a63fcd1ec7dfcb761b13cd02fe2abf234fdc6d05))
* **ui:** prevent gengar image clipping during crossfade animation ([39055b9](https://github.com/theyusa/KunBox/commit/39055b9f5cfe1e0c624212bfb29ea77dad7d271b))
* **ui:** toggle fab visibility on scroll ([c42cff8](https://github.com/theyusa/KunBox/commit/c42cff82b5f3c9e7e21c951ee0b617f54866799a))
* **ui:** 列表到底部时隐藏悬浮按钮 ([a232719](https://github.com/theyusa/KunBox/commit/a23271949474e9b777c2872d64ea29069e9c00e6))
* **ui:** 应用分流仅显示仅允许列表中的应用并移除直连选项 ([05ff1da](https://github.com/theyusa/KunBox/commit/05ff1da8acb967b3be6b1de88c53460200603180))
* ui控制参数 ([6745e0d](https://github.com/theyusa/KunBox/commit/6745e0d65bf1d4f0a81b92bca73137e1fa7eef3b))
* **ui:** 调整 BigToggle 图像显示 ([8a53ced](https://github.com/theyusa/KunBox/commit/8a53ced548eaf4cca29909706eb37c3a59bae928))
* **vpn:** add data plane connectivity verification and auto-recovery escalation ([4e66000](https://github.com/theyusa/KunBox/commit/4e660001117d2a0fc86e1c1d35989cb647be395f))
* **vpn:** hot reload failure causes network loss ([2000436](https://github.com/theyusa/KunBox/commit/20004364e3aa3e56a1d731f9a2e5f1762f70b335))
* **vpn:** per-app proxy settings not applied to TUN interface ([f3a9320](https://github.com/theyusa/KunBox/commit/f3a93203861231fb83704c739687ec12c9b36d42))
* **vpn:** 修复VPN自动关闭和启动期间连接泄漏问题 ([9975a2e](https://github.com/theyusa/KunBox/commit/9975a2ea6f4f8746f7f999477aff6ec864f059ba))
* **vpn:** 修复多个 VPN 启动和节点切换问题 ([f61fb11](https://github.com/theyusa/KunBox/commit/f61fb11acc18bcb158698204e2393ce541a0ede7))
* **vpn:** 修复息屏后 Telegram 等应用卡在加载中的问题 ([093ab71](https://github.com/theyusa/KunBox/commit/093ab71863228341421a8e61f6aee6614ef21cb1))
* **vpn:** 全面加固 VPN 息屏保活机制,防止被系统杀死 ([0b39d09](https://github.com/theyusa/KunBox/commit/0b39d0981024dd5be46fc6efa160eab2a41a8ffd))
* **vpn:** 添加周期性健康检查防止 VPN 服务僵尸状态 ([843d4ec](https://github.com/theyusa/KunBox/commit/843d4ecb413485663f72fd4c56a00c01f90cc2cb))
* 一些优化 ([a671207](https://github.com/theyusa/KunBox/commit/a67120767789fa0e4ee949c676edca079dd854f9))
* 一些已知问题 ([2622695](https://github.com/theyusa/KunBox/commit/2622695a3d9565d76b1007f9c3401ff7b5f87b61))
* 主题适配 ([234924c](https://github.com/theyusa/KunBox/commit/234924cc7d537167d50e091c5a70abff23e5b2a1))
* 优化 ([567b554](https://github.com/theyusa/KunBox/commit/567b5542ef48b785fb10fbf884f8474b8f19563f))
* 优化 SingBoxCore 代码注释和错误处理 ([d69bd8d](https://github.com/theyusa/KunBox/commit/d69bd8dc5b4849179e17e1170e049098d286c1ec))
* 优化延迟测试 ([a1fdcb4](https://github.com/theyusa/KunBox/commit/a1fdcb47f221edc69228f6af080e9453b8be0251))
* 优化延迟测试 ([7b67a0a](https://github.com/theyusa/KunBox/commit/7b67a0a26888099c0e06a66dae838cda10a3afb9))
* 优化构建配置和 ProGuard 混淆规则 ([046362a](https://github.com/theyusa/KunBox/commit/046362af725fb7d87bcd9ea3e93a6365a15b0aca))
* 优化网络稳定 ([b03dd47](https://github.com/theyusa/KunBox/commit/b03dd47ed083fcd9795ecf0baabb5066607d5a72))
* 优化订阅更新逻辑 ([75fa6c5](https://github.com/theyusa/KunBox/commit/75fa6c5d0ec4227f8e10b02b5734ec22e8e6036a))
* 优化重连、断连、热重载 ([95b3bfd](https://github.com/theyusa/KunBox/commit/95b3bfd547be8ba80e091f096b0eb7049c6cef6e))
* 修复了一些已知问题 ([51f6994](https://github.com/theyusa/KunBox/commit/51f6994d20f6edf52f71f8ed163383feced4fb15))
* 修复了热切换节点后 连接延迟的问题 ([894b2af](https://github.com/theyusa/KunBox/commit/894b2affa8ce6a8a6ac53c3837b11b75b0d22f71))
* 修复从通知栏进入app后返回键需按两次才能退出的问题 ([1240f82](https://github.com/theyusa/KunBox/commit/1240f8246a52b05189a33502577157873d223bb2))
* 修复节点选择状态未正确保存和显示的问题 ([1cdf3f7](https://github.com/theyusa/KunBox/commit/1cdf3f7f69ff23dff50cb18ee748725d595e21b7))
* 修复跨配置切换节点时无法上网的问题 ([ab3ba67](https://github.com/theyusa/KunBox/commit/ab3ba67ac8c0deea104f1ee2cde16d7250ec09da))
* 修复首次前台误触发DEEP恢复导致连接卡住 ([ed7a774](https://github.com/theyusa/KunBox/commit/ed7a774c073c715fa58b9bb579a6976502e1fe3c))
* 全局禁用endpoint_independent_nat和auto_route ([2aa437e](https://github.com/theyusa/KunBox/commit/2aa437ecba131769cb32b2f94a84bdcb4206a4a2))
* 关于应用里加上app本体及singbox的版本号 ([2c6bd61](https://github.com/theyusa/KunBox/commit/2c6bd61777b3f61d615ca4496ff6358539c9109b))
* 删除组逻辑 ([5aa7021](https://github.com/theyusa/KunBox/commit/5aa702157adf0cfbb92aec1eb810105ca96e990b))
* 只读节点信息 ([4c0976b](https://github.com/theyusa/KunBox/commit/4c0976b9e2eb3f8305cb91a32bd2b97ecce55fd5))
* 可能解决了一些闪退的问题 ([ef5e728](https://github.com/theyusa/KunBox/commit/ef5e7283710ac2839548fe1bfe9a99303c8304f3))
* 同步官方内核 ([f054302](https://github.com/theyusa/KunBox/commit/f054302a5c90c74e9ff95ae52ab0929b844e363e))
* 增加日志开关 ([9beb8ff](https://github.com/theyusa/KunBox/commit/9beb8ff72f75911b04fef7e0335e9a4c650c53ea))
* 增强稳定性 ([223c19f](https://github.com/theyusa/KunBox/commit/223c19f2f004701afef7988c8f9a2358c026d07e))
* 多处优化 ([189e8c9](https://github.com/theyusa/KunBox/commit/189e8c9077b167f9d6ca10b3869aff544af48bca))
* 多处变动 ([9299dcb](https://github.com/theyusa/KunBox/commit/9299dcb9159b8643e6aca234f4a723070d202b92))
* 多节点闪退 ([d0d26e5](https://github.com/theyusa/KunBox/commit/d0d26e5a7d9ce3a386107a91b771976c16f8ccab))
* 大量重构 ([8b99ba1](https://github.com/theyusa/KunBox/commit/8b99ba1ac1602164e533968bac7f3584e6002b5b))
* 实时显示上传和下载速度 ([0af613e](https://github.com/theyusa/KunBox/commit/0af613ee7a5aa3afb2b2d4140ed0c2de11f601cd))
* 实现配置管理，加号按钮里面本地文件和扫描二维码 ([ec24666](https://github.com/theyusa/KunBox/commit/ec24666f53992d0137469513f520f3db9275fb0f))
* 尝试修复fakeip的问题 ([3ffc626](https://github.com/theyusa/KunBox/commit/3ffc6268fb68b220d691d398e0ca4dc24091668e))
* 常规优化 ([5a8f38d](https://github.com/theyusa/KunBox/commit/5a8f38d056e2b0eaa26fd4a12cba6636cf7d5b2b))
* 底部导航切换过渡动画、磁贴按钮 ([1a4f92c](https://github.com/theyusa/KunBox/commit/1a4f92c06b4b104088149d52bb223894305c66b3))
* 性能优化 ([4e3cfee](https://github.com/theyusa/KunBox/commit/4e3cfee07cfb44ad8b66a291df9561b6cbc729bc))
* 性能优化 ([38b27c0](https://github.com/theyusa/KunBox/commit/38b27c07aba1165c203ba1dc04fb133ae38c0c83))
* 新内核 ([a1bcad1](https://github.com/theyusa/KunBox/commit/a1bcad131ffc42bf68a7caf0f578a6c23f588893))
* 新增 URL Scheme 深度链接支持和问题修复文档 ([5432a6b](https://github.com/theyusa/KunBox/commit/5432a6b948e705bc49fec833e626c521f612a829))
* 新增应用启动时清理遗留临时数据库文件的功能 ([1bf5a2a](https://github.com/theyusa/KunBox/commit/1bf5a2a6f27b32a7be22fb7af9c15e36223756e7))
* 新增项目文档索引和优化指南 ([108d3b9](https://github.com/theyusa/KunBox/commit/108d3b9a1fcb3fa891dff3fcd9686d4f5358b537))
* 更新 planning-with-files submodule 和临时修复代码 ([dffd1e9](https://github.com/theyusa/KunBox/commit/dffd1e90c5b92f5ca27e3f103df7d645a39a5dad))
* 更新镜像、添加导入导出数据功能 ([a20a115](https://github.com/theyusa/KunBox/commit/a20a115986e7d0ef646dca830a4788135a4c3433))
* 清理不必要的临时文件和 planning-with-files ([04f9670](https://github.com/theyusa/KunBox/commit/04f96701c1f8f8c4fee5422cdecb9f08aa459776))
* 清理冗余调试日志以提升性能和可读性 ([dd3a404](https://github.com/theyusa/KunBox/commit/dd3a404a0301ed2a8be4550a9b3ef196e34b4726))
* 清理废弃的构建脚本并优化 libbox 构建流程 ([de78f57](https://github.com/theyusa/KunBox/commit/de78f576f6e998a326cc9a0d3d55dbcbc84990c4))
* 移除内核版本管理功能并优化核心服务 ([931e169](https://github.com/theyusa/KunBox/commit/931e1697574444ecf59c565b402aac169a5b7d93))
* 移除已过时的 bugfix 文档 ([2e80582](https://github.com/theyusa/KunBox/commit/2e8058272a2c113347d9a196c8af7c621734ee78))
* 移除节点名称自动添加协议后缀 ([2bd0423](https://github.com/theyusa/KunBox/commit/2bd0423a97ccb72c40b725c5df226b1fc98710f7))
* 稳定网络 ([2bcd87d](https://github.com/theyusa/KunBox/commit/2bcd87d8e21d210704662f487fe0849450d6fea2))
* 统一 TUN MTU 默认值并移除冗余日志 ([7af9639](https://github.com/theyusa/KunBox/commit/7af96395f66d20b3c79a7d105eb5bbcf9eab643e))
* 规则集定时自动更新 ([b1803b4](https://github.com/theyusa/KunBox/commit/b1803b40ab9590ebb5d358ac6219ed16a6a72898))
* 解决 VPN 快速重启导致的网络接口不同步问题 ([0732fd6](https://github.com/theyusa/KunBox/commit/0732fd607529d3d28522320a698f5bab67ea10dd))
* 解析器识别 anytls 节点 ([742cd95](https://github.com/theyusa/KunBox/commit/742cd95d84e429df2f22ffc7ebab552b7f63fb27))
* 订阅定时更新 ([0363898](https://github.com/theyusa/KunBox/commit/0363898cc9377c9f4cd6042a74f01cfbcc24c94a))
* 部分订阅节点丢失 ([ecb9f74](https://github.com/theyusa/KunBox/commit/ecb9f745eda3443e02a25014ec6e626c195504a3))
* 长按功能 ([276fc8e](https://github.com/theyusa/KunBox/commit/276fc8e3589660a9e19573f23c4a5678fcac13dd))
* 长按图标出现的操作选项 ([db340c0](https://github.com/theyusa/KunBox/commit/db340c095572ce3cdf5cd6414ef903a21b445bfa))
* 首页设计 ([3a86145](https://github.com/theyusa/KunBox/commit/3a86145d750e62abb38de4a0f6521ba0efc0cb51))


### Performance Improvements

* implement 4 performance optimizations ([465a7ee](https://github.com/theyusa/KunBox/commit/465a7eea13a46c2a8a6448dfa82acc29d9d30b69))
* **network:** optimize throughput and enable GSO ([ed83201](https://github.com/theyusa/KunBox/commit/ed832018a458ed55de3a627f0fda47ef457f4b1e))
* **repository:** optimize node import performance and add Kryo serialization ([29f8268](https://github.com/theyusa/KunBox/commit/29f8268ee3d93492684fd510e648ac3b4df09bdf))
* **repository:** parallelize node extraction and subscription updates ([a86228e](https://github.com/theyusa/KunBox/commit/a86228e6994b0cf6662fd3d359473e53434519de))
